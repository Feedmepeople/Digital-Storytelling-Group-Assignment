...
<p>Το έργο αφορά έναν νέο ενήλικα χωρίς ιδιαίτερη γνώση για το πως λειτουργεί ο κόσμος και ανυπομονεί να δει τι τον περιμένει. Προφανώς σαν άπειρος, σε κάποιους τομείς, ενήλικας τον περιμένουνε κάποιες κακοτυχίες.
Πως θα αντιδράσει σε αυτές και τι θα μάθει από τα λάθη του.</p>
...
<p>Το σημαντικότερο γεγονός είναι μετά από έναν αγώνα πάλης μεταξύ των πρωταγωνιστών όπου ο 1ο ετής καταλαβαίνει γιατί των συμβούλευέ ο 5ο ετής.</p>
...
<p>Το κύριο στοιχείο που διευρύνει το σενάριο είναι διάλογος και αναστροφή στο παρελθών.</p>
...
<p>Συμβαίνει στη σύγχρονη εποχή με βάση τις σύγχρονες σχολές.</p>
...
<p>Αφηγείται στον πραγματικό κόσμο.</p>

**3.4.	Πώς παρουσιάζεται γεωγραφικά;** 
<p>Η πλοκή του σεναρίου δεν είναι ανάγκη να βρίσκονται σε συγκεκριμένο σημείο αλλά τα γυρίσματα θα γίνουνε στη Σύρο.</p>
...
<p>Ο πρωταγωνιστής μας είναι ο 1ο ετής (όνομα δεν σκεφτήκαμε ακόμα), ο συμπρωταγωνιστής είναι ο 5ο ετής (όνομα δεν σκεφτήκαμε ακόμα) και για κομπάρσους το βλέπουμε ακόμα.</p>
...
<p>Θεωρητικά ναι, καθώς οι πρωταγωνιστές είναι δύο απλοί άνθρωποι όπου περιορίζονται μόνο από τον τρόπο σκέψης τους.</p>
...
<p>Δεν είναι σίγουρη η χρήση κομπάρσων αυτή την στιγμή αλλά θα μπορούσαν να χρησιμοποιηθούν με θετικό αποτέλεσμα.</p>
...
<p>Το πρότζεκτ είναι μια ταινία μικρού μήκους.</p>
...
<p>Γιατί υπάρχει το φαινόμενο της ταύτισης όπου κάνει τους θεατές να νοιώθουν λιγότερο μόνοι.</p>

**7.6.	Υπάρχουν άλλα τέτοια έργα;** 
<p>Υπάρχουν αλλά δεν μπορούμε να πούμε ονομαστικά καθώς υπάρχουν χαρακτηρίστηκα από διαφορετικές ταινίες.</p>
...
<p>Δεν ήταν ο σκοπός να είναι κερδοφόρο οπότε δεν υπήρχαν και έσοδα.</p>
...
<p>Θα υπάρξει ήχος, διάλογοι και μουσική.
